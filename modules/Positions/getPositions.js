// Helper function that gives the positions of cannons, cannon balls and possible player positions ( not current position)
// Note the function gives only mathematical values, without the units
